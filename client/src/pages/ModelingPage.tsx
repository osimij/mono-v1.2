  ...
  return (
    <div className="p-6">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">ML Modeling</h1>
          <p className="text-gray-600 dark:text-gray-300">Build predictive models with one-click training</p>
        </div>
